      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-4">
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link to="/tourist-visa" className="btn btn-primary">Learn More</Link>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link to="/work-visa" className="btn btn-primary">Learn More</Link>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link to="/student-visa" className="btn btn-primary">Learn More</Link>
            </div>
          </div>
        </div>
      </div>
