...
const VisaHome = () => {
  const [visas, setVisas] = useState(null); // Start with null instead of []
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/visas")
      ...
      .catch((error) => {
        console.error(error);
        setVisas([]); // Empty array on failure
        setLoading(false); // Done loading
      });
  }, []);
